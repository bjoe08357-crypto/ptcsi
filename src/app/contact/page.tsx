            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                  Whether you have a question about our services, want to discuss a potential project, or just want to say hello — we&apos;d love to hear from you. Our team typically responds within 24 hours.
                </p>
              </div>
        ...
        <Container size="md">
          <div className="text-center bg-gradient-to-br from-blue-600 to-purple-700 rounded-3xl p-10 lg:p-16 shadow-2xl">
            ...
            <p className="text-blue-100 text-lg mb-8 max-w-xl mx-auto">
              Let&apos;s transform your ideas into reality. Reach out today and get a free consultation.
            </p>
